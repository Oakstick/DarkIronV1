path = r"D:\DarkIron\darkiron\packages\editor\src\App.tsx"
with open(path, "r", encoding="utf-8") as f:
    old = f.read()

new_content = r'''import { useEffect, useRef, useState } from "react";
...
print("Fixed App.tsx: now uses @darkiron/transport, removed direct nats.ws import, typed properly")
