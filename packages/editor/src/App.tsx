  ...
  const statusRight = (
    <div style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 11 }}>
      ...
      <div style={{
        ...
        background: status === "connected" ? "#22c55e" : status === "error" ? "#ef4444" : "#f59e0b",
      }} />
  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", background: "#1e1e1e" }}>
      ...
      <div style={{
        ...
        padding: "0 12px", borderBottom: "1px solid #252526",
      }}>
        <span style={{ color: "#E31B23", fontWeight: 700, fontSize: 11, letterSpacing: 2 }}>DARKIRON</span>
      ...
      <div style={{ flex: 1, position: "relative" }}>
        ...
        {error && (
          <div style={{
            ...
            borderRadius: 8, border: "1px solid #E31B23",
      ...
      <div style={{
        ...
        padding: "0 10px", fontSize: 11, color: "#fff",
      }}>
        <span>{sceneName}</span>
